...
export class FooterComponent {
  ...
  logos = [
    { src: 'https://www.dubaitraveltourism.com/assets/images/paytab.png', alt: 'PayTab' },
    { src: 'https://www.dubaitraveltourism.com/assets/images/security.png', alt: 'Security' },
    { src: 'https://www.dubaitraveltourism.com/assets/images/payments.png', alt: 'Payments' },
    { src: 'https://www.dubaitraveltourism.com/assets/images/godaddy.png', alt: 'GoDaddy' }
  ];
